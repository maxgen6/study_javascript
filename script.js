...
const plus1 = document.getElementsByTagName('h1')[0];

const plus2 = document.getElementsByTagName('h1')[1];

const checkbox = document.querySelector('#deposit-check');

const additionalIncome = document.querySelectorAll('.additional_income-item');

const resultBudgetDay = document.querySelector('.result-total budget_day-value');

const resultBudgetMonth = document.querySelector('.resultBudgetDay');

const additionalValue = document.querySelector('.result-total additional_income-value');

const additionalExpenses= document.querySelector('.result-total additional_expenses-value');

const incomePeriod = document.querySelector('.result-total income_period-value');

const targenMonth = document.querySelector('.result-total target_month-value');
...
const resultIncomePeriod = document.querySelector('.result-total income_period-value');

const resultTargetMonth = document.querySelector('.result-total target_month-value');
